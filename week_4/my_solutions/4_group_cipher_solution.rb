...
# we redefine decoded_sentence as a string from the get-go, we don't need to join it together at the end. shortened the driver codes
# and used a built-in method instead of hash. we had some difficulty using the match method but we found how to do it.
